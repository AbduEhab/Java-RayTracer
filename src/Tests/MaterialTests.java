...
public class MaterialTests {
    ...
    public void lighting() {
        ...
        assertEquals(true, m.lighting(l, p, eyev, normalv).equals(res), "Material lighting is not valid");
        ...
        assertEquals(true, m.lighting(l, p, eyev, normalv).equals(res), "Materiallighting is not valid");
